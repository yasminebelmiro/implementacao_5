...
Devido à forma como as arestas foram adicionadas e ao comportamento característico da pilha (último a entrar, primeiro a sair), o algoritmo executa um efeito serpente (zigue-zague) pelas colunas do grafo.
